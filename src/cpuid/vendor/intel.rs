...
impl Intel {
    ...
    pub fn micro_arch(model: &str, s: CpuSignature) -> CpuArch {
        ...
        match (
            ...
            (0, 6, 0, 1, 2) => brand_arch(MicroArch::PentiumPro, "P6", Some(N600)),
            (0, 6, 0, 1, 6..10) => brand_arch(MicroArch::PentiumPro, "P6", Some(N350)),
            ...
            (0, 6, 0, 9, 5) => brand_arch(MicroArch::PentiumIII, "Banias", Some(N130)),
            ...
            (0, 6, 0, 13, 8) => brand_arch(MicroArch::Dothan, "Dothan", Some(N90)),
            (0, 6, 0, 14, _) => brand_arch(MicroArch::Yonah, "Yonah", Some(N65)),
            (0, 6, 0, 15, 6) => brand_arch(MicroArch::Core, "Merom", Some(N65)),
            (0, 6, 1, 6, _) => brand_arch(MicroArch::Core, "Merom-L", Some(N65)),
            (0, 6, 1, 7, 0) => brand_arch(MicroArch::Core, "Yorkfield", Some(N45)),
