...
impl MicroArch {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            MicroArch::ArrowLake => "Arrow Lake",
            MicroArch::BartlettLake => "Bartlett Lake",
            ...
            MicroArch::ClearwaterForest => "Clearwater Forest",
            MicroArch::CoffeeLake => "Coffee Lake",
            MicroArch::CometLake => "Comet Lake",
            MicroArch::CooperLake => "Cooper Lake",
            MicroArch::Core => "Core",
            MicroArch::Crestmont => "Crestmont",
            MicroArch::CougarCove => "Cougar Cove",
            MicroArch::CypressCove => "Cypress Cove",
            MicroArch::Darkmont => "Darkmont",
            MicroArch::DiamondRapids => "Diamond Rapids",
            MicroArch::Dothan => "Dothan",
            MicroArch::Dunnington => "Dunnington",
            MicroArch::EmeraldRapids => "Emerald Rapids",
            MicroArch::GoldenCove => "Golden Cove",
            MicroArch::Goldmont => "Goldmont",
            MicroArch::GoldmontPlus => "Goldmont Plus",
            MicroArch::Gracemont => "Gracemont",
            MicroArch::GrandRidge => "Grand Ridge",
            ...
            MicroArch::KnightsMill => "Knights Mill",
            MicroArch::Lakefield => "Lakefield",
            MicroArch::Lakemont => "Lakemont",
            MicroArch::LionCove => "Lion Cove",
            MicroArch::LunarLake => "Lunar Lake",
            MicroArch::Merom => "Merom",
            MicroArch::MeteorLake => "Meteor Lake",
            MicroArch::Nehalem => "Nehalem",
            MicroArch::Northwood => "Northwood",
            MicroArch::NovaLake => "Nova Lake",
            MicroArch::P5 => "P5",
            MicroArch::PalmCove => "Palm Cove",
            MicroArch::PantherLake => "Panther Lake",
